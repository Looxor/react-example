export default {
  ...
  SIGNUP: {
    ADD_MAJOR_EMAIL: {
      CONFIRM_EMAIL: "Repeti email",
      CONTINUE: "CONTINUA",
      DESCRIPTION: "Ciao {firstname}, per poter continuare ad utilizzare the[bold]faculty[/bold] ci servirebbe avere una tua email che [bold]non[/bold] sia universitaria e sapere il tuocorso di laurea",
      EMAIL: "Email",
