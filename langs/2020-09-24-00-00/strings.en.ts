export default {
  ...
  TEST: {
    ...
    ERROR_WHILE_GETTING_DATA: "An error occurred while getting data. Try again later.",
    ...
    INSTANCE_DETAIL: {
      ...
      SELEXI_DESC: "Le domande che troverai in questa simulazione e la sua struttura ricalcano il più fedelmente possibile ciò che potrai trovare il giorno dell’esame. Le domande sono state verificate e validate da Selexi, società che opera nel settore da oltre 20 anni",
      TITLE: "Nuovo test",
