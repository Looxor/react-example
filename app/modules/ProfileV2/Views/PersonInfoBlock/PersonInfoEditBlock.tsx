...
const GENDERS = [
  {text: strings.PROFILE.HOME.GENDER_M, value: 'M'},
  {text: strings.PROFILE.HOME.GENDER_F, value: 'F'},
  {text: strings.PROFILE.HOME.GENDER_O, value: 'O'},
];
...
const PersonInfoEditBlock = props => {
  ...
  const selectDateFilterHandler = async value => {
    saveData();
  };
  return (
    <View style={styles.container}>
      ...
      />
      <Text>Gender: {String(gender)}</Text>
      <RadioBox
        data={GENDERS}
        containerStyle={{}}
