...
const PrizeBoxUsedV3 = props => {
  ...
  const selectCouponPrizeHandler = couponPrize => {
    if (onSelectCouponPrize) {
      onSelectCouponPrize({prize: couponPrize});
    }
  };
  ...
  return (
    <TouchableOpacity
      ...
      onPress={() => selectCouponPrizeHandler(couponPrize)}>
      ...
      <View style={styles.ribbonImageContainer}>
        <Image
          resizeMode={'contain'}
          style={styles.ribbonImage}
          source={require('../../../../../../../assets/images/icons/icn_giftcard_small.png')}
        />
      </View>
      <View style={styles.brandContainer}>
        <FastImage
          resizeMode={'contain'}
          source={{uri: couponPrize.prize_partner_image_url}}
      ...
      <View style={styles.detailView}>
        <Text
          ...
          numberOfLines={2}
          ellipsizeMode={'tail'}>
          {couponPrize.prize_title}
        </Text>
        <Text style={[styles.detailDesc, {color: getValidLabelColor()}]}>
          {!(!is_expired && is_almost_expired && !couponPrize.marked_used) &&
