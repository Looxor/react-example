...
import styles from "./StudentEmailPending.style";
...
const StudentEmailPending = props => {
...
StudentEmailPending.navigationOptions = ({navigation}) => {
...
export default StudentEmailPending;
